    ...
    do
    {
        ...
        if(input == 1)
        {
            ...
            if(!isFull)
            {
                ...
                {
                    thisClient->chatTimedout = false; // Resetta chatTimedout
                ...
                } while (thisClient->isConnected && thisClient->chatTimedout);        
            }
        }
        ...
        if(thisClient->actualRoomID != -1) // Se appartiene ad una stanza
        {
